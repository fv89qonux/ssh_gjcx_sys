...
<body>
  ...
  <s:form action="user_insert" namespace="/user" method="post">
    	...
    	<s:iterator value="#request.userList" var="user">
    		<tr>
    			...
    			<td class="tableboder"  align="center" bgcolor="#FFFFFF">
    				<a href="user/user_detail?memberdto.tbMember.id=<s:property value='#user.id'/>">详细</a>&nbsp;&nbsp;|
    				<a href="user/user_delete?memberdto.tbMember.id=<s:property value='#user.id'/>">删除</a>    			
    		    </td>
    		</tr>
    	</s:iterator>
    	<tr><td align="right" colspan="4">
					<p style="font-size: 13px;">
					<pg:pager maxPageItems="${pageSize }" url="${ctx}/user/user_search.action" items="${totalCount }"
