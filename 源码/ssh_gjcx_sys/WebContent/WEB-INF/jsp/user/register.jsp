...
function save() {
	...
	if (document.getElementById("pwd1").value != document.getElementById("passWord").value) {
		alert("密码不一致！");
		return false;
	}

	document.dd.action = "<%=path %>/user/user_insert";
	document.dd.submit();
}
</script>
	...
	<body>
		<s:form name="dd" action="user_insert" namespace="/user" method="post">
					...
					<td valign="top" >
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td colspan="2"
									background="<%=request.getContextPath()%>/images/shop_16.gif"
									align="center"><div align="center" ><font class="word_green" size="3"><b >会员注册</b></font></div></td>
							</tr>
						</table>
						</td>
							</tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td height="189" valign="top" align="center"> 
									...
									<table width="100%" border="0" cellspacing="-2"
										...
										<tr>
											...
											<td width="82%" class="word_grey">
												<s:textfield name="memberdto.tbMember.userName"
													cssClass="text" id="userName" size="30" />
										...
										<tr>
											...
											<td height="28">
												<s:password name="memberdto.tbMember.passWord"
													cssClass="text" id="passWord" size="30" />
												<span class="word_orange">*</span>
											</td>
										</tr>
										<tr>
											...
											<td height="28">
												<input name="pwd1" id="pwd1" type="password" size="30" maxlength="30">
												<span class="word_orange">*</span>
											</td>
										</tr>
										<tr>
